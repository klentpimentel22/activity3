...
public class act3librarysystem{
    public static void main(String[] args) {
        Book book1 = new Book("together and ever", "Nicholas Sparks", "2002");
        Book book2 = new Book("the night gardener", "George Pelecanos", "2007");
        DVD dvd1 = new DVD("Avengers Endgame", "Joe and Adam Russo");
        DVD dvd2 = new DVD("Avatar the Last Airbender", "M. Night Shymalan");
